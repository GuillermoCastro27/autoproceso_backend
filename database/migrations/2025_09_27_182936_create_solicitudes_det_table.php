...
return new class extends Migration
{
    ...
    {
        Schema::create('solicitudes_det', function (Blueprint $table) {
            ...
            $table->float('soli_det_cantidad');
            $table->float('soli_det_costo');
            $table->integer('soli_det_cantidad_stock');
            $table->primary(['solicitudes_cab_id','item_id']);
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('solicitudes_det');
    }
};
