...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('ctas_pagar', function (Blueprint $table) {
            ...
            // Cambiar float por decimal para mayor precisiÃ³n en montos monetarios
            $table->decimal('cta_pag_monto', 10, 2); // 10 dÃ­gitos, 2 decimales
            
            // Cambiar timestamp por date si solo necesitas la fecha
            $table->date('cta_pag_fecha');
            
            // Validar si cta_pag_cuota necesita ser string o algÃºn otro tipo
