...
<div class="wrapper">
    ...
    <div class="header">
        ...
        <div>
            <span class="doc-num">PEDIDO N° {{ str_pad($datos['id'], 7, '0', STR_PAD_LEFT) }}</span>
        </div>
    </div>

    <div class="body">
        <p>Se le notifica el siguiente pedido de compra para su revisión.</p>
        ...
        <div class="two-col">
            <div class="col">
                <div class="info-box">
                    ...
                    <table>
                        <tr><td>Fecha:</td><td>{{ $datos['ped_fecha'] }}</td></tr>
                        <tr><td>Plazo entrega:</td><td>{{ $datos['ped_vence'] }}</td></tr>
                        <tr><td>Estado:</td>
                            <td>
                                @php
                                    $bc = match($datos['ped_estado']) {
                                        'CONFIRMADO' => 'badge-confirmado',
                                        'ANULADO'    => 'badge-anulado',
                                        default      => 'badge-pendiente',
                                    };
                                @endphp
                                <span class="badge {{ $bc }}">{{ $datos['ped_estado'] }}</span>
                            </td>
                        </tr>
                        <tr><td>Observaciones:</td><td>{{ $datos['ped_pbservaciones'] ?? '—' }}</td></tr>
                    </table>
                </div>
            </div>
            <div class="col">
                <div class="info-box">
                    <h3>Empresa / Encargado</h3>
                    <table>
        ...
        <div class="section">
            ...
            <table class="det">
                <thead>
                    <tr><th>#</th><th>Producto</th><th class="tc">Cant.</th><th class="tc">Stock Disp.</th><th>Depósito</th></tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="tc">{{ $d->cantidad }}</td>
                        <td class="tc">{{ $d->cantidad_stock ?? 0 }}</td>
                        <td>{{ $d->dep_nombre }}</td>
                    </tr>
                    @endforeach
                </tbody>
        ...
        <div class="notice">
            Este correo fue generado automáticamente como comprobante del pedido de compra.
        </div>
    </div>
